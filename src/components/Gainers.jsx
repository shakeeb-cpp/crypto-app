...
const Gainers = () => {
    ...
    const GainerList = data?.['Top Gainers'];

    if (isFetching) return <Loader />;
    return (
        <>
            <Title level={2} className="heading">Top Gainer Cryptos</Title>
            <Row style={{ padding: '12px 10px' }}>
                <Col span={6}><strong>Coins</strong></Col>
                <Col span={6}><strong>Price</strong></Col>
                <Col span={6}><strong>Rise 24hr</strong></Col>
                            ...
                            <Panel
                                ...
                                header={(
                                    <Row key={items.Symbol}>
                                        <Col span={6}>
                                            {/* <Text><strong>{items.Rank}.</strong></Text> */}
                                        ...
                                        <Col span={6}>{millify(items?.['Rise 24hr'])}%</Col>
